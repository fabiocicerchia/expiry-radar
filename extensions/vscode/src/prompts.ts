  ...
  const what = await vscode.window.showQuickPick(
    [
      ...
      },
      {
        ...
        detail: "A date you know: a registrar with no RDAP, a credential rotated by hand, a contract.",
...
export function pickExportFormat(): Thenable<ExportChoice | undefined> {
  return vscode.window.showQuickPick<ExportChoice>(
    [
      ...
      {
        label: "iCal feed",
        description: "renewals as calendar events, with alarms by blast radius",
        format: "ical",
        ext: "ics",
      },
